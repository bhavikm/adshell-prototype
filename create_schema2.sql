...
CREATE TABLE JobType (
                ...
                jobTypeDescription VARCHAR(50) NOT NULL,
...
CREATE TABLE BusinessDetails (
                ...
                tradingName VARCHAR(60) NOT NULL,
                PRIMARY KEY (applicationID)
);
...
ALTER TABLE Information ADD CONSTRAINT employee_information_fk
FOREIGN KEY (employeeLastUpdate)
REFERENCES Employee (employeeID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE BusinessDetails ADD CONSTRAINT businesstype_businessdetails_fk
...
ALTER TABLE BusinessDetails ADD CONSTRAINT application_businessdetails_fk
FOREIGN KEY (applicationID)
REFERENCES Application (applicationID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE PartnersAuthorization ADD CONSTRAINT businesspartners_partnersauthorization_fk
FOREIGN KEY (businessPartnetID)
REFERENCES BusinessPartners (businessPartnetID)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
