...
<div class="container" id="apply-page">
	<h1 class="spacing-under">Application - Page 7 - Authorisations and Acknowledgements</h1>
	<div class="row">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-8 col-md-offset-2">
			...
			<form class="form" role="form">
			  ...
			  <div class="row">
				  <div class="col-md-3">
					<label for="inputPhone" class="control-label">Date of Birth</label>
				  </div>
				  <div class="col-md-4">
					 <input type="text" class="form-control" id="inputPhone" placeholder="Date of Birth">
				  </div>
			  </div>
			  <div class="row">
				  <div class="col-md-3">
					<label for="inputName" class=" control-label">Driver's Licence Number</label>
				  </div>
				  <div class="col-md-9">
					<input type="text" class="form-control" id="inputName" placeholder="Driver's Licence Number">
				  </div>
			  </div>
			  <div class="row">
				  <div class="col-md-3">
			  ...
			  <div class="row">
				  <div class="col-md-6 col-md-offset-3">
					 <br />
					 <a class="btn btn btn-primary" href="index.php?apply&page=8">Next Step &raquo;</a>
				  </div>
			  </div>
			</form>
